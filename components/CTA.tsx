...
const CTA = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      {/* Background - Modo claro: naranja claro */}
      <div 
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className="absolute top-20 left-10 w-96 h-96 rounded-full blur-3xl animate-pulse transition-colors duration-500"
          style={{
        ...
        ></div>
        <div 
          className="absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl animate-pulse transition-colors duration-500"
          style={{
            animationDelay: '1s',
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(15)].map((_, i) => (
          <Sparkles
            key={i}
            className="absolute animate-float transition-colors duration-500"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              animationDelay: `${Math.random() * 3}s`,
              animationDuration: `${3 + Math.random() * 2}s`,
              color: isDark ? '#F27405' : '#0476D9',
              opacity: 0.4,
            }}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-8">
            <Logo size="lg" className="transform hover:scale-110 transition-transform duration-300" />
          </div>
